...
export default function Popover(props: PopoverProps) {
    ...
    return (
        <HeadLessUiPopover className="relative">
            {button ? button : <HeadLessUiPopover.Button>{label}</HeadLessUiPopover.Button>}
                <Transition
                ...
                >
                    <HeadLessUiPopover.Panel className={clsx("absolute z-10 bg-gray-8 rounded-md overflow-hidden min-w-[250px] mt-2 left-0")}>
                    {children}
...
const PopoverButton = (props: PopoverButtonProps) => {
    ...
    return <HeadLessUiPopover.Button className={clsx(className)}>
        {children}
