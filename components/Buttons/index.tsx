...
export const SubmitButtonStyles =
  "bg-white rounded-lg w-full py-4 text-black text-base font-semibold hover:opacity-90 disabled:bg-gray-7 hover:disabled:opacity-100 disabled:cursor-not-allowed"
